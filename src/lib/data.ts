export interface Service {
  ...
  keywords?: string[];
  /* 주요 업무. 한 줄짜리 목록(details)만으로는 무엇을 어떻게 하는지가
     안 읽혀서, 이름을 앞에 세우고 그 아래에 하는 일을 적는다.
     글은 전부 이 사이트에 이미 있던 문장을 다시 묶은 것이다. */
  mainWork?: Array<{ title: string; body: string }>;
...
export const services: Service[] = [
  /* ── 세무자문 ───────────────────────────────────────────── */
  {
    ...
    mainWork: [
      {
        title: "매월 장부 작성과 급여 · 원천세 신고",
        body: "법인 · 개인사업자의 월별 장부를 작성하고 계정을 분류합니다. 자료 요청 루틴을 설계해 증빙 누락을 함께 점검합니다. 급여 · 원천세 및 4대보험 관련 신고를 지원합니다.",
      },
      {
        title: "부가가치세 신고 일정 운영",
        body: "부가가치세 · 원천세 신고 일정을 운영합니다. 기한 전에 필요한 자료를 먼저 요청하고, 신고를 마치면 접수증과 납부 안내를 드립니다.",
      },
      {
        title: "기장 이관과 기초 세무 질의",
        body: "기장을 옮겨 오면 기존 장부의 오류와 누락부터 점검합니다. 일하는 중에 생기는 기초적인 세무 질의에는 빠르게 응답합니다.",
      },
    ],
    details: [
  ...
  },
  {
    ...
    mainWork: [
      {
        title: "당기 세무조정",
        body: "법인세 · 종합소득세 세무조정을 검토합니다. 결산 장부를 보고 익금산입 · 손금불산입 항목을 확인해 반영합니다.",
      },
      {
        title: "공제 · 감면 적용 검토",
        body: "이월결손금과 세액공제 · 감면 적용 가능성을 검토합니다. 가지급금 · 특수관계자 거래 같은 주요 세무 이슈도 같이 점검합니다.",
      },
      {
        title: "신고 전 최종 검토와 과거 신고 정정",
        body: "신고서를 내기 전에 쟁점을 정리하고 마지막으로 봅니다. 과거 신고 정정(수정신고 · 경정청구)은 자료를 본 뒤 범위를 따로 정합니다.",
      },
    ],
    details: [
      "법인세 · 종합소득세 세무조정 검토",
  ...
  },
  {
    ...
    mainWork: [
      {
        title: "증빙 정리와 전표 입력",
        body: "받은 증빙을 정리하고 전표를 입력합니다. 그 결과를 원장으로 작성합니다.",
      },
      {
        title: "급여 · 신고 기초자료 준비",
        body: "급여와 신고에 필요한 기초자료를 준비하는 실무를 지원합니다.",
      },
      {
        title: "미결 항목 정리",
        body: "처리가 남은 항목을 모아 정리합니다. 세무기장은 장부 작성과 세무신고를 직접 수행합니다 — 겹치는 범위는 계약 전에 구분합니다.",
      },
    ],
    details: [
      "증빙 정리",
  ...
  /* ── 회계감사 ───────────────────────────────────────────── */
  {
    ...
    mainWork: [
      {
        title: "재무제표 감사",
        body: "재무제표를 감사하고 독립된 감사의견을 제시합니다.",
      },
      {
        title: "수임 전 독립성 · 범위 확인",
        body: "감사를 맡기 전에 독립성과 업무 범위를 확인합니다.",
      },
      {
        title: "회계기준 적용 검토",
        body: "K-IFRS와 일반기업회계기준 적용을 검토합니다. 결산 지원은 감사업무와 구분해 회계자문에서 다룹니다.",
      },
    ],
    details: [
  ...
  /* ── 회계자문 ───────────────────────────────────────────── */
  {
    ...
    mainWork: [
      {
        title: "결산 마감과 재무제표 작성",
        body: "결산 마감과 재무제표 작성을 지원합니다. 주석을 작성하고 계정을 정리합니다.",
      },
      {
        title: "신규 거래 회계처리 검토",
        body: "신규 계약이나 거래의 회계처리를 정할 때, 계약서와 증빙을 검토해 회계기준에 맞는 방안을 드립니다.",
      },
      {
        title: "감사 질의 대응",
        body: "감사인 질의에 맞춰 근거 자료를 갖추고 대응을 돕습니다.",
      },
    ],
    details: [
      "결산 마감과 재무제표 작성 지원",
  ...
  },
  {
    ...
    mainWork: [
      {
        title: "IPO 사전 진단",
        body: "회계 · 내부통제 · 지배구조를 미리 진단합니다.",
      },
      {
        title: "K-IFRS 전환과 지정감사 대응",
        body: "K-IFRS 전환을 준비하고 지정감사에 대응합니다.",
      },
      {
        title: "상장 준비 회계자료 정비",
        body: "상장 준비에 필요한 회계자료를 정비합니다.",
      },
    ],
    details: [
  ...
  /* ── 재무자문 ───────────────────────────────────────────── */
  {
    ...
    mainWork: [
      {
        title: "실사 범위 확정",
        body: "무엇을 어디까지 볼지 먼저 정합니다.",
      },
      {
        title: "요청 자료 및 거래 증빙 대조",
        body: "요청한 자료와 거래 증빙을 맞춰 봅니다.",
      },
      {
        title: "주요 자산 · 부채 및 투자금 내역 확인",
        body: "주요 자산과 부채, 투자금 내역을 확인합니다.",
      },
      {
        title: "실사 결과 보고서 작성",
        body: "확인한 내용을 보고서로 정리해 드립니다.",
      },
    ],
    details: [
      "실사 범위 확정",
  ...
  },
  {
    ...
    mainWork: [
      {
        title: "비상장주식 공정가치 평가",
        body: "현금흐름할인법(DCF) · 시장접근법 · 자산접근법으로 보통주 가치를 산정합니다.",
      },
      {
        title: "세법상 주식 · 자산 평가",
        body: "상속세 및 증여세법, 법인세법 기준으로 주식과 자산을 평가합니다.",
      },
      {
        title: "주식연계증권 · 합병 비율 산정",
        body: "스톡옵션 · 전환사채 등 주식연계증권의 공정가치를 산출합니다. 합병 · 분할 시 합병비율과 분할가액도 산정합니다.",
      },
    ],
    details: [
