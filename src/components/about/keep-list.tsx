...
const ITEMS = [
  {
    ...
    body: "고객과의 소통에 더 많은 시간을 할애할 수 있도록, 단순·반복 작업은 자체 개발 솔루션으로 자동화·체계화합니다.",
  ...
  },
  {
    num: "02",
    title: "염가경쟁을 하지 않습니다.",
    body: "염가 수임은 정당한 대가를 지불해주시는 고객분들께서 받으셔야 할 서비스 품질을 떨어뜨립니다. 정당한 대가로 업무를 수임하고 지속가능하게 운영하는 것은 메리디안과 함께하는 고객님 그리고 직원과의 약속입니다.",
  ...
  },
  {
    num: "03",
    title: "회계사가 많이 일합니다.",
    body: "적게 일하고 많이 벌겠다는 욕심을 버리고, 직접 발로 뛰고 더 많이 고민합니다.",
